define(
        ...
        function(Backbone, NumberMixin, EditTemplate, EditListItemViewTemplate, FacturaModel, DataGrid, FacturaTotalView, ClientsSearchCollection, SeriesCollection, Autocomplete)
        {
